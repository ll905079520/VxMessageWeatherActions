...
public class WechatConfig {
     ...
     * appId
     */
    public static final String VxAppId = "wx4ab75cd08452138b";

    /**
     * 你的微信的密钥
     * appSecret
     */
    public static final String VxAppSecret = "5f553fa8ae042ae66f8d79622eca6bb9";
    ...
    static {
        userList.add(getUser(
                "oK-EU6QRY7vgRtfDcrtPPokWjT28", //扫码关注你的测试号以后，测试平台会出现TA的微信号
                "pIS_SgIMy5frQ419Xsj6f66w1ubz_owpF93MsdgRfnA", //要给这个人发送的模板ID
                "宝宝", //咋称呼这个人
                "重庆", //这个人的详细地址
                "重庆", //这个人在的城市
                new BirthDay(2023,3,11,true,false,"！！！纪念日！！！"),
        ...
        userList.add(getUser(
               "oK-EU6c4KIYOLE6RNN9WI_hVqdG0", //扫码关注你的测试号以后，测试平台会出现TA的微信号
                "pIS_SgIMy5frQ419Xsj6f66w1ubz_owpF93MsdgRfnA", //要给这个人发送的模板ID
                "宝宝", //咋称呼这个人
                "重庆", //这个人的详细地址
                "重庆", //这个人在的城市
